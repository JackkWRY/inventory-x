...
import com.stockmanagement.inventory.application.service.ConfirmReservationUseCase;
...
class ConfirmReservationUseCaseTest {
    ...
    void shouldConfirmReservationSuccessfully() {
        ...
        when(stockMapper.toResponse(any(Stock.class))).thenReturn(new StockResponse(
                "id", "SKU-001", "L001", "80", "0", "PIECE", 1L, "now", "now"));

        // Act
        confirmReservationUseCase.execute(command);
