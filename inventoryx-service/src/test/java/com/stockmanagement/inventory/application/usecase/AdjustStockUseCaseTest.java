...
import com.stockmanagement.inventory.application.service.AdjustStockUseCase;
...
class AdjustStockUseCaseTest {
    ...
    void shouldAdjustStockSuccessfully() {
        ...
        AdjustStockCommand command = new AdjustStockCommand(
                stock.getId().toString(), "150", "Audit Correction", "Auditor");
        ...
        when(stockMapper.toResponse(any(Stock.class))).thenReturn(new StockResponse(
                "id", "SKU-001", "L001", "150", "0", "PIECE", 1L, "now", "now"));
